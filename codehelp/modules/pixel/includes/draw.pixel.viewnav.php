		...
		?>
			<div class="te te_delete_form">
				<form class="te te_delete_form" name="frm" method="post" action="<?php echo htmlspecialchars($this->url( "te_mode=delete&te_key=" . $this->te_key )); ?>">
					...
					<input class="cancel_button" type="button" name="btnCancel" value="Cancel" onclick="document.location='<?php echo htmlspecialchars($this->url( 'te_mode=' . $this->_default_mode_after_save . '&te_key=' . $this->te_key )); ?>';" />
				</form>
			</div>
		<?php
	}
